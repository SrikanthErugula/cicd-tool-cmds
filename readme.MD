...
### 🔐 Vulnerabilities
A security-related holes that can be exploited by attackers. This can be hacked (means hacker code lopaliki vachhi bom pelchtum)
...
### 🔒 Security Rating
Rating based on severity of vulnerabilities ( ekkuva vulnerabilities vunte "E", zreo vulnerabilities vunte "A")
